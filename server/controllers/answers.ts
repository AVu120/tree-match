...
const answerQuestion2 = (answer: string) => {
  if (answer === "yes")
    return {
      question: {
        step_id: 3,
...
const answerQuestion3 = (answer: string) => {
  if (answer === "yes")
    return {
      question: null,
      match: {
...
const answerQuestion4 = (answer: string) => {
...
const answerQuestion5 = (answer: string) => {
  if (answer === "yes")
    return {
      question: {
        step_id: 6,
...
const answerQuestion6 = (answer: string) => {
...
const answerQuestion7 = (answer: string) => {
  if (answer === "yes")
    return {
      question: null,
      match: {
...
const answerQuestion11 = (answer: string) => {
  if (answer === "none")
    return {
      question: null,
      match: {
...
export const answerQuestion = (req: any, res: any, next: any) => {
  const { step_id, answer }: AnswerRequestBody = req.body;
  switch (step_id) {
    case 1:
